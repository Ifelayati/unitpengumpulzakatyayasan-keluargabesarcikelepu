<!-- footer_start  -->
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="address_line">
                                <li>+555 0000 565</li>
                                <li><a href="#">upzykbc@gmail.com</a></li>
                                <li>Sekertariat KBC Jln selaawi limbangan Kp kebon jeruk RT 02 RW 09 Desa putra jawa Kec. selaawi Kab.Garut</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3  col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="links">
                                ...
                                <li><a href="<?=BASEURL;?>/Web/partner">Program</a></li>
  ...
  Copyright &#169; <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> <a expr:href='data:blog.homepageUrl'><data:blog.title/></a>. UPZ-YKBC | Powered by UPZ-YKBC</a>
