<!-- Breadcome start-->
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Tabel <span class="table-project-n">Data</span>  Program</h1>
                                    </div>
                                </div>
                                
                                <div class="sparkline13-graph">
                                  <p align="left"><a href="<?= BASEURL; ?>/Mesjid/tambah" button type="button" class="btn btn-primary">Tambah</a>
                                  </p>
        ...
        foreach( $data['pnr'] as $pnr) : ?><tr>
                    ...
                    <td><?=$no++ ?>.</td>
          <td><?= $pnr['nama_program'];?></td>
          <td><?= $pnr['tujuan'];?></td>
          <td><?= $pnr['alokasi_dana'];?></td>
          <td><?= $pnr['penerima_manfaat'];?></td>
          <td>
